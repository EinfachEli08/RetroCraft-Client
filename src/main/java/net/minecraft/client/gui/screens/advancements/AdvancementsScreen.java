...
public class AdvancementsScreen extends Screen implements ClientAdvancements.Listener {
   ...
   protected void init() {
      ...
      gridlayout$rowhelper.addChild(Button.builder(Component.translatable("gui.stats"), (p_2808199_) -> {
       ...
       gridlayout$rowhelper.addChild(Button.builder(Component.translatable("gui.done"), (p_2808599_) -> {
    	   this.minecraft.setScreen(new PauseScreen(true));
         // this.minecraft.getReportingContext().draftReportHandled(this.minecraft, this, this::onDisconnect, true);
       }).width(105).build(), 1);
      
      gridlayout.arrangeElements();
      FrameLayout.alignInRectangle(gridlayout, 0, 0, this.width, this.height, 0.5F, 0.750F);
   ...
   public void render(GuiGraphics gfx, int p_282255_, int p_283354_, float p_283123_) {
      int i = (this.width - 252) / 2;
      int j = (this.height - 140) / 2;
      this.renderBackground(gfx);
      this.renderInside(gfx, p_282255_, p_283354_, i, j);
      this.renderWindow(gfx, i, j);
      this.renderTooltips(gfx, p_282255_, p_283354_, i, j);
      
      super.render(gfx, p_282255_, p_283354_, p_283123_);
     
         //gfx.blit(AbstractWidget.WIDGETS_LOCATION, this.statsButton.getX() + this.statsButton.getWidth() - 17, this.statsButton.getY() + 3, 182, 24, 15, 15);
