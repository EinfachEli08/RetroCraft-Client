...
public interface GuiEventListener extends TabOrderedElement {
   ...
   default boolean contKeyPressed(int p_94745_, int p_94746_, int p_94747_) {
	   return false;
   }
   
   default boolean contKeyReleased(int p_94745_, int p_94746_, int p_94747_) {
	   return false;
   }
   ...
   default boolean isCursorOver(double p_94748_, double p_94749_) {
	      return false;
	   }
